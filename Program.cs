...
namespace task2
{
	...
	internal class GroupManager
	{
		...
		public void InteractiveAddStudent(Group group)
		{
			bool isActive = true;
			do
			{
				...
				Console.Write("> Enter Student Type(Good or Bad): ");
		...
		public void EnterInteractive()
		{
			...
			do
			{
				...
				Console.WriteLine("[1] Get brief info");
				Console.WriteLine("[2] Get full info");
				...
				switch (selectedOption)
				{
					...
					case ConsoleKey.D3:
						InteractiveAddStudent(selectedGroup);
						break;
					case ConsoleKey.D4:
						isShown = false;
						break;
